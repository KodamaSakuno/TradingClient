...
![现货交易界面](docs/images/01.png)

![期权分析模块](docs/images/02.png)

## 能力矩阵（均为真实环境验证，非 mock）

| 交易所 | 账户模式 | 现货 | 合约（USDT 永续） | 订单查询 | 验证方式 |
|---|---|---|---|---|---|
| Gate | Classic | 行情 / 下单 / 撤单 / 余额 / 私有订单推送 | 下单 / 杠杆 / 持仓 / 双向持仓 / 持仓推送 / 强平预警 | 期货已接入 / 现货进行中 | testnet 全链路冒烟通过 |
| Bitget | Unified (UTA) | 行情 / 下单 / 撤单 / 余额 / 私有订单推送 | — | 现货进行中 | 模拟盘全链路冒烟通过 |
